    ...
    <section class="mx-auto w-full max-w-6xl space-y-8">
        ...
        <div class="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="rounded-2xl border border-black/10 bg-white p-6">
                ...
                <p class="mt-1 text-4xl font-bold text-slate-900">${{ number_format($stats['totalRevenue'], 0) }}</p>
                <p class="mt-2 text-sm text-slate-500">+15% from last month</p>
            </div>
        </div>
            ...
            <div class="rounded-2xl border border-black/10 bg-white p-6">
                ...
                <div class="space-y-4">
                    @foreach ($recentActivities as $activity)
                        <div class="flex items-start gap-3 border-b border-black/10 pb-4 last:border-none last:pb-0">
                    ...
                    <tbody class="text-base text-slate-700">
                        @foreach ($latestBookings as $booking)
                            ...
                            <tr class="border-b border-black/10 last:border-none">
                                ...
                                <td class="px-3 py-4 font-semibold text-slate-900">${{ number_format((float) $booking->total_price, 0) }}</td>
                                <td class="px-3 py-4">
