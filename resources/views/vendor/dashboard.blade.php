...
<div class="max-w-[920px] mx-auto">
    ...
    <div class="grid grid-cols-4 gap-4 mb-5">
        <a href="{{ route('vendor.vehicles.index') }}" class="block bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:shadow-md hover:border-blue-200 transition">
    ...
    <div class="grid grid-cols-2 gap-4 mb-5">
        <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm min-h-[190px]">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xs font-bold text-gray-900">Recent Bookings</h2>
                <a href="{{ route('vendor.bookings.index') }}" class="text-[11px] text-blue-600 font-medium hover:text-blue-800">
                    View All →
                </a>
            </div>
                ...
                @forelse($recentBookings->take(3) as $booking)
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <span class="inline-block mt-1 px-2 py-0.5 rounded-full text-[10px] {{ $statusClass }}">
                                {{ ucfirst($status) }}
                            </span>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm min-h-[190px]">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xs font-bold text-gray-900">Top Performing Vehicles</h2>
                <a href="{{ route('vendor.vehicles.index') }}" class="text-[11px] text-blue-600 font-medium hover:text-blue-800">
                    View All →
                </a>
            </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
        <div class="flex justify-between items-center mb-4">
            ...
            <a href="{{ route('vendor.reviews.index') }}" class="text-[11px] text-blue-600 font-medium hover:text-blue-800">View All →</a>
        </div>
