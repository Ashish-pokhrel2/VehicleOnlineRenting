<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Right Side: Auth Links / User Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 hover:text-gray-800 dark:hover:text-white focus:outline-none transition ease-in-out duration-150">
                ...
                @else
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('login') }}"
                            class="text-sm text-gray-700 dark:text-gray-300 hover:text-blue-600">
                            Login
                        </a>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
            <div class="pt-4 pb-4 border-t border-gray-200 dark:border-gray-600 px-4 space-y-2">
                <a href="{{ route('login') }}"
                    class="block text-gray-700 dark:text-gray-300 hover:text-blue-600">
                    Login
                </a>
                <a href="{{ route('register') }}"
                    class="block px-4 py-2 text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700">
                    Sign Up
                </a>
            </div>
        @endauth
